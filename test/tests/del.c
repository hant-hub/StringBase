...
int main() {
    ...
    assert(data->refs[strs[0]] == 2);
    StrBaseDel(data, strs[0]);
    assert(data->refs[strs[0]] == 1);
    StrBaseDel(data, strs[0]);
    assert(data->refs[strs[0]] == 0);
    assert(data->strstore[strs[0]].data == NULL);
    assert(data->strstore[strs[0]].len == 0);
